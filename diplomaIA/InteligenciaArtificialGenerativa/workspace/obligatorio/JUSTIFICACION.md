...
Los gráficos siguen un orden narrativo: cada modelo se introduce solo después de mostrar el problema que resuelve.

1. Gráficos 1-2: Problema de Vanilla (saturación) → Solución de WGAN (Wasserstein)
2. Gráficos 3-4: Problema de WGAN (clipping, gradientes) → Necesidad de mejora
3. Gráficos 5-6: Solución de WGAN-GP (pesos naturales, gradientes estables)
4. Gráfico 7: Comparación final de muestras generadas

### Duración del Entrenamiento

Se entrenaron 400 épocas por modelo, suficientes para observar convergencia o colapso. El tiempo total fue ~9.3 horas (Vanilla: 1h, WGAN: 2.75h, WGAN-GP: 5.6h).
