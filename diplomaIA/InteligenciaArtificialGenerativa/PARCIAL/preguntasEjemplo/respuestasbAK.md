...
El profesor mencionó que "los grandes modelos de lenguaje condicionan el contexto pero el contexto es acotado. No pueden condicionar a más de n mil palabras hacia atrás."

**LSTM (y RNNs en general):**
- Procesan secuencia token por token
...
- En la práctica, capturan dependencias de ~50-100 tokens máximo

**Transformers (GPT-2):**
- Usan mecanismo de atención: cada posición puede "mirar" todas las anteriores
- No hay compresión forzada en un estado fijo
- Las dependencias largas son tan "baratas" como las cortas
- El profesor explicó: "GPT, ¿cómo nos genera texto? Bueno, nos genera haciendo muestreos, condicionando una palabra respecto a las anteriores"
