...
- Esto se suma al embedding de cada palabra (el embedding es el vector numérico que representa a esa palabra — sale de una tabla que convierte cada palabra/ID del vocabulario en una lista de números donde palabras similares tienen vectores similares)
